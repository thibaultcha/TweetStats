...
import tweetstats.TweetstatsFactory;
 ...
 * @generated
 */
public class TweetstatsPackageImpl extends EPackageImpl implements TweetstatsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see tweetstats.TweetstatsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TweetstatsPackageImpl() {
		super(eNS_URI, TweetstatsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link TweetstatsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TweetstatsPackage init() {
		if (isInited) return (TweetstatsPackage)EPackage.Registry.INSTANCE.getEPackage(TweetstatsPackage.eNS_URI);

		// Obtain or create and register package
		TweetstatsPackageImpl theTweetstatsPackage = (TweetstatsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TweetstatsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TweetstatsPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theTweetstatsPackage.createPackageContents();

		// Initialize created meta-data
		theTweetstatsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTweetstatsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TweetstatsPackage.eNS_URI, theTweetstatsPackage);
		return theTweetstatsPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTweet_Message() {
	 ...
	 * @generated
	 */
	public EAttribute getFetch_Date() {
	 ...
	 * @generated
	 */
	public EAttribute getFetch_Last_id() {
	 ...
	 * @generated
	 */
	public EReference getFetch_Results() {
		return (EReference)fetchEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public TweetstatsFactory getTweetstatsFactory() {
		return (TweetstatsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(fetchEClass, FETCH__LAST_ID);
		createEReference(fetchEClass, FETCH__RESULTS);
	}
